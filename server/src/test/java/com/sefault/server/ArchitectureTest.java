...
public class ArchitectureTest {
    ...
    static final ArchRule controllers_must_not_depend_on_entities = noClasses()
            ...
            .because("Controllers must only return DTOs. Leaking database entities to the web layer is strictly forbidden.");
    ...
    static final ArchRule repositories_protected = classes()
            ...
            .orShould().onlyBeAccessed().byClassesThat().haveSimpleNameEndingWith("ServiceImpl")
