...
class EmployeePredictionServiceTest {
    ...
    @Mock
    private EmployeePerformanceStatRepository statRepo;

    @Mock
    private EmployeePerformancePredictionRepository predRepo;
    ...
    void generateEmployeeForecasts_IteratesAllActiveEmployees() {
        ...
        when(statRepo.findTop30ByEmployeeCinAndPeriodTypeOrderByStatDateDesc(anyString(), any()))
                .thenReturn(List.of(
                        mockStat, mockStat, mockStat, mockStat, mockStat, mockStat, mockStat, mockStat, mockStat,
                        mockStat)); // 10 days
